/*
    ...
    * Avec une interface de programmation nous permettant de parcourir le DOM, nous allons pouvoir INTÉRAGIR avec lui. Ces intéractions comprennent:
    ...
    */
     ...
     */
     ...
     /*
         Afin de modifier notre page HTML selon les intéraction d'un utilisateur nous allons modifier notre DOM grâce à JavaScript.
     ...
     | (nom de balise, #id ou .class)               |
     | sélectionne toutes les balises en ensemble   |
     \*--------------------------------------------*/
